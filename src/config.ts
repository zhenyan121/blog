...
export const siteConfig: SiteConfig = {
	title: "Mizuki",
	subtitle: "a blog by a lazy man",
	siteURL: "https://zhenyan121.top/", // 请替换为你的站点URL，以斜杠结尾
	siteStartDate: "2026-02-17", // 站点开始运行日期，用于站点统计组件计算运行天数
	...
	bilibili: {
		vmid: "628937914", // 在此处设置你的Bilibili用户ID (uid)，例如 "1129280784"
	...
	links: [
		...
		// 支持自定义导航栏链接，支持多级菜单
		{
			...
			children: [
				{
					name: "GitHub",
					url: "https://github.com/zhenyan121/blog",
					external: true,
					icon: "fa7-brands:github",
				},
				{
					name: "Bilibili",
					url: "https://space.bilibili.com/628937914",
					external: true,
...
export const profileConfig: ProfileConfig = {
	...
	name: "zhenyan121",
	bio: "在这个世界都很急躁的时候，需要找一片能静得下心的地方。",
	typewriter: {
	...
	links: [
		...
		},
		{
			name: "GitHub",
			icon: "fa7-brands:github",
			url: "https://github.com/zhenyan121",
		},
	],
};
...
export const musicPlayerConfig: MusicPlayerConfig = {
	...
	meting_api:
		"https://melting.zhenyan121.top/api?server=:server&type=:type&id=:id&auth=:auth&r=:r", // Meting API 地址
	id: "8754371086", // 歌单ID
